...
public :
   ...
   Float_t         MC_JPsi_e[200];
   Float_t         MC_JPsi_px[200];
   Float_t         MC_JPsi_py[200];
   Float_t         MC_JPsi_pz[200];
   TClonesArray    *MC_Bhad_4vector;
   Float_t         MC_Bhad_e[200];
   Float_t         MC_Bhad_px[200];
   Float_t         MC_Bhad_py[200];
   Float_t         MC_Bhad_pz[200];
   Int_t           MC_Bhad_id[200];
   TClonesArray    *MC_Bquark_4vector;
   Float_t         MC_Bquark_e[200];
   Float_t         MC_Bquark_px[200];
   Float_t         MC_Bquark_py[200];
   Float_t         MC_Bquark_pz[200];
