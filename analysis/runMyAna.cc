...
//_________________________
  ...
  TChain* PFpart = new TChain("PFpart");
  ...
  cout << "======================================================================" << endl;
  MyAna ana(muons, electrons, jets, MET, vertices, events, HLT, muonsloose, electronsloose, PFpart, MC); //instantiate one MyAna object
